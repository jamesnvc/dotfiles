...
;; (hs.hotkey.bind hyper "f" (fn [] (switch-to "org.mozilla.librewolf")))
(hs.hotkey.bind hyper "f" (fn [] (switch-to "com.vivaldi.Vivaldi")))
(hs.hotkey.bind hyper "i" (fn [] (switch-to "com.tapbots.Ivory")))
...
(hs.hotkey.bind hyper "v" (fn [] (switch-to "com.vivaldi.Vivaldi")))
