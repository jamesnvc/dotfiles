...
(defconst cogent/pragmata-ligature-chars
  '(("!!"        #XE900)
    ("!="        #XE901)
    ("!=="       #XE902)
    ("!!!"       #XE903)
  ...
  (progn
    ...
    (dolist (char-re (cogent/pragmata-ligature-chars-to-composition-alist))
      (set-char-table-range composition-ligature-table
                            (car char-re)
                            `([,(cdr char-re) 0 compose-gstring-for-graphic])))
    (set-char-table-parent composition-ligature-table composition-function-table)
    (defun cogent/enable-composition-ligatures ()
      (setq-local composition-function-table composition-ligature-table))
    (add-hook 'prog-mode-hook #'cogent/enable-composition-ligatures)))
